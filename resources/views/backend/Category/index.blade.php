...
<div class="col-md-6">
@if(isset ($model))    
{{ Form::model($model, ['route' => ['admin.category.update', $model], 'class' => 'form-horizontal', 'files'=> 'true', 'role' => 'form', 'method' => 'PATCH']) }}
@else
...
@endif
  ...
  <div class="box box-primary">
			...
			<div class="form-group">
                {{ Form::label('description','description', ['id' =>'editor1','class' => 'col-lg-2 control-label']) }}
...
<div class="col-md-6">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">
                <a href="{!! url('category') !!}" class="btn btn-primary">add</a>
              category
                </h3>
