...
@section('after-styles')
    ...
    <LINK href="{!! url('public/css/mine.css') !!}" rel="stylesheet" type="text/css">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="thumbnail">
                                        ...
                                        <div class="gallery clearfix">
                                            <a href="{!! url('public/uploads/photo/'.$photo->image) !!}"
                                               rel="prettyPhoto[gallery2]"
                                               title="{!! $photo->title !!}"><img
                                                        src="{!! url('public/uploads/photo/thumbnail/'.$photo->image) !!}"
                                                        class="action"
                                                        alt=""/>
