		...
		<div class="row">
			<div class="col-md-9">
				...
				<div class="blog-grid margin-bottom-30">
					...
					<img class="img-responsive" src="{{url('public/uploads/Article/'.$data->file)}}" alt="">
				</div>
				<!-- End Blog Grid -->
				...
				<ul class="blog-grid-tags">
				   <strong>Category:</strong> <li class="head">{{$data->articlecategory->title}}</li>
				</ul>
				<!-- End Blog Grid Tagds -->
						...
						<div class="col-sm-3 col-xs-6 sm-margin-bottom-30">
							...
							<div class="blog-thumb-v4">
								<div class="blog-thumb-item">
									<img class="img-responsive margin-bottom-10" src="{{url('public/uploads/Article/'.$row->file)}}" alt="">
