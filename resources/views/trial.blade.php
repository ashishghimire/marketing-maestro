                                    ...
                                    @if($nepali_featured == null)
                                        <div class="blog-grid sm-margin-bottom-40">
                                            <img class="img-responsive notfeatured-image"
                                                 src="{{url('public/uploads/Slider/im1.jpeg')}}"
                                                 alt="Loading!!">
                                    ...
                                    @else
                                        <div class="blog-grid sm-margin-bottom-40">
                                            <img class="img-responsive featured-image"
                                                 src="{{url('public/uploads/Advertising1/'.$nepali_featured->file)}}"
                                                 alt="Loading!!">
                                            <h3>
                                            ...
                                            <div class="blog-thumb-grad">
                                                <a href="{{url('show',$row->slug)}}">
                                                    <img class="small-image"
                                                         src="{{url('public/uploads/Advertising1/'.$row->file)}}"                                                         alt="">
                                                </a>
                                                <a class="hover-grad"
                            ...
                            <div class="row">
                                <div class="col-sm-7">
                                    ...
                                    @else
                                        <div class="blog-grid sm-margin-bottom-40">
                                            <img class="img-responsive featured-image"
                                                 src="{{url('public/uploads/Advertising1/'.$indian_featured->file)}}"
                                                 alt="loading!!">
                                            <h3>
                                    ...
                                    @forelse($indian as $row)
                                        <div class="blog-thumb-v2 margin-bottom-20">
                                            <div class="blog-thumb-grad">
                                                <a href="{{url('show',$row->slug)}}">
                                                    <img class="small-image"
                                                         src="{{url('public/uploads/Advertising1/'.$row->file)}}"
                                                         alt="Loading">
                                                </a>
                                                <a class="hover-grad"
                                                   href="{{url('show',$row->slug)}}">
                            ...
                            <div class="row">
                                <div class="col-sm-7">
                                    ...
                                    @else
                                        <div class="blog-grid sm-margin-bottom-40">
                                            <img class="img-responsive featured-image"
                                                 src="{{url('public/uploads/Advertising1/'.$english_featured->file)}}"
                                                 alt="Loading!!">
                                            <h3>
                            ...
                            {{--<div class="row">--}}
                                {{--<div class="col-sm-7">--}}
                                    ...
                                    {{--@if($books_featured == null)--}}
                                        {{--<div class="blog-grid sm-margin-bottom-40">--}}
                                            {{--<img class="img-responsive notfeatured-image"--}}
                                                 {{--src="{{url('public/uploads/Slider/im1.jpeg')}}"                                                 alt="">--}}
                                            {{--<h3><a href="#">No Featured Post</a></h3>--}}
                                            {{--<ul class="blog-grid-info">--}}
                                            {{--</ul>--}}
                                    ...
                                    {{--@else--}}
                                        {{--<div class="blog-grid md-margin-bottom-40">--}}
                                            {{--<div class="blog-grid-grad">--}}
                                                {{--<img class="img-responsive featured-image"--}}
                                                     {{--src="{{url('public/uploads/OtherResource',$books_featured->file)}}"--}}
                                                     {{--alt="Loading!!">--}}
                                        ...
                                        {{--<div class="blog-thumb-v2 margin-bottom-20">--}}
                                            {{--<div class="blog-thumb-grad">--}}
                                                {{--<a href="{{url('resource/show',$book->slug)}}">--}}
                                                    {{--<img class="small-image"--}}
                                                         {{--src="{{url('public/uploads/OtherResource',$book->file)}}"--}}
                                                         {{--alt="Loading!!">--}}
                                                {{--</a>--}}
                                                {{--<a href="{{url('resource/show',$book->slug)}}">--}}
                                                    {{-- <i class="fa fa-video-camera"></i> --}}
                                ...
                                {{--<div class="col-sm-7">--}}
                                    ...
                                    {{--@else--}}
                                        {{--<div class="blog-grid md-margin-bottom-40">--}}
                                            {{--<div class="blog-grid-grad">--}}
                                                {{--<img class="img-responsive featured-image"--}}
                                                     {{--src="{{url('public/uploads/OtherResource',$movies_featured->file)}}"--}}
                                                     {{--alt="">--}}
                                ...
                                {{--<div class="col-sm-5">--}}
                                    ...
                                    {{--@forelse($movies as $movie)--}}
                                        {{--<div class="blog-thumb-v2 margin-bottom-20">--}}
                                            {{--<div class="blog-thumb-grad">--}}
                                                {{--<img class="small-image"--}}
                                                     {{--src="{{url('public/uploads/OtherResource',$movie->file)}}"--}}
                                                     {{--alt="Loading!!">--}}
                        ...
                        {{--@forelse($resource_popular as $resource)--}}
                            {{--<div class="item">--}}
                                {{--<div class="row">--}}
                                    {{--<div class="col-sm-5 sm-margin-bottom-20">--}}
                                        {{--<img class="img-responsive latest-image"--}}
                                             {{--src="{{url('public/uploads/OtherResource/'.$resource->file)}}"--}}
                                             {{--alt="{{$resource->title}}">--}}
                                    {{--</div>--}}
                                ...
                                {{--<div class="col-sm-7">--}}
                                    ...
                                    {{--@else--}}
                                        {{--<div class="blog-grid md-margin-bottom-40">--}}
                                            {{--<div class="blog-grid-grad">--}}
                                                {{--<img class="img-responsive featured-image"--}}
                                                     {{--src="{{url('public/uploads/CaseStudy',$featured_post_casestudy->file)}}"--}}
                                                     {{--alt="Loading!!">--}}
                                        ...
                                        {{--<div class="blog-thumb-v2 margin-bottom-20">--}}
                                            {{--<div class="blog-thumb-grad">--}}
                                                {{--<a href="{{url('casestudy/show',$casestudy->slug)}}">--}}
                                                    {{--<img class="small-image"--}}
                                                         {{--src="{{url('public/uploads/CaseStudy',$casestudy->file)}}"--}}
                                                         {{--alt="Lodaing!!">--}}
                                                {{--</a>--}}
                                                {{--<a href="{{url('casestudy/show',$casestudy->slug)}}">--}}
                                                    {{-- <i class="fa fa-video-camera"></i> --}}
                            ...
                            {{--<div class="row">--}}
                                {{--<div class="col-sm-7">--}}
                                    ...
                                    {{--@if($featured_post_interview == null)--}}
                                        {{--<div class="blog-grid sm-margin-bottom-40">--}}
                                            {{--<img class="img-responsive notfeatured-image"--}}
                                                 {{--src="{{url('public/uploads/Slider/im2.jpeg')}}"--}}
                                                 {{--alt="Loading!!">--}}
                                            {{--<h3><a href="#">No Featured Post</a></h3>--}}
                                            {{--<ul class="blog-grid-info">--}}
                                            {{--</ul>--}}
                                    ...
                                    {{--@else--}}
                                        {{--<div class="blog-grid md-margin-bottom-40">--}}
                                            {{--<div class="blog-grid-grad">--}}
                                                {{--<img class="img-responsive featured-image"--}}
                                                     {{--src="{{url('public/uploads/Interview',$featured_post_interview->file)}}"--}}
                                                     {{--alt="Loading!!">--}}
                                        ...
                                        {{--<div class="blog-thumb-v2 margin-bottom-20">--}}
                                            {{--<div class="blog-thumb-grad">--}}
                                                {{--<a href="{{url('interview/show',$interview->slug)}}">--}}
                                                    {{--<img class="small-image"--}}
                                                         {{--src="{{url('public/uploads/Interview',$interview->file)}}"--}}
                                                         {{--alt="Loading!!">--}}
                                                {{--</a>--}}
                                                {{--<a href="{{url('interview/show',$interview->slug)}}">--}}
                                                    {{-- <i class="fa fa-video-camera"></i> --}}
