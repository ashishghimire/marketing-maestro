						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown home active">
								...
								<ul class="dropdown-menu">
									<li class=""><a href="index.html">gkahglkjahlk</a></li>
									<li class=""><a href="index.html">Home Default Page</a></li>
									<li class=""><a href="index.html">Home Default Page</a></li>
									<li class=""><a href="index.html">Home Default Page</a></li>
									<li class=""><a href="index.html">Home Default Page</a></li>
									<li class=""><a href="index.html">Home Default Page</a></li>
									...
									{{-- <li class="dropdown-submenu">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="blog_page_layouts4.html">Page Layouts v4</a></li>
										</ul>
									</li> --}}
									<!-- End Post Layouts -->
							...
							<li class="dropdown ">
								...
								<ul class="dropdown-menu">
									@foreach(articlecategory() as $row)
									<li class=""><a href="{{url('article/' .$row->slug)}}">{{$row->title}}</a></li>
									@endforeach
