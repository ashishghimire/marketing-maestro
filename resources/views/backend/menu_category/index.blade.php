...
<div class="col-md-6">
@if(isset ($model))    
{{ Form::model($model, ['route' => ['admin.menucategory.update', $model], 'class' => 'form-horizontal', 'files'=> 'true','role' => 'form', 'method' => 'PATCH']) }}
@else
{{ Form::open(['route' => 'admin.menucategory.store', 'class' => 'form-horizontal', 'files'=> 'true','role' => 'form', 'method' => 'post']) }}
@endif
  ...
  <div class="box box-primary">
    ...
    <div class="box box-info">
        <div class="box-body">
            <div class="pull-left">
                {{ link_to_route('admin.menucategory.create', trans('cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
            </div><!--pull-left-->
                    ...
                    <table id="users-table" class="table table-condensed table-hover">
                        ...
                        @foreach($data as $field)
                            <tr>
                                ...
                                <td><a href="{{url('menucategory/show',$field->id)}}">{!! $field->title !!}</a></td>
                                ...
                                <td class="col-md-1"> 
                                {!! link_to_route('admin.menucategory.edit', '', array($field->id),
                                              array('class' => 'fa fa-pencil-square-o fa-fw')) !!}
                                    
                                  <td class="col-md-1"> 
                                  {!! link_to_route('admin.menucategory.delete', '', array($field->id),
